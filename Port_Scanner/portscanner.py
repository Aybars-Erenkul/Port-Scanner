...
class ScanThread(QThread):
    ...
    signal_detect_os = pyqtSignal(str)
...
class Ui_dialog(object):
    ...
    def setupUi(self, dialog):
        ...
        self.tabWidget.setStyleSheet("""QTabBar::tab:!selected{ background: #293436 }
        QTabBar::tab:selected {background-color: grey;}""")
        #self.tabWidget.setStyleSheet("QTabBar::tab:selected {background-color: blue;}")
        ...
        self.ScannedList.setGeometry(QRect(5, 130, 281, 231))
        ...
        self.OpenList.setGeometry(QRect(295, 130, 296, 231))
        ...
        #Creating a box for OS Detection
        self.DetectOS = QTextEdit(self.ScannerTab)
        self.DetectOS.setEnabled(True)
        self.DetectOS.setGeometry(QRect(295, 380, 296, 38))
        self.DetectOS.setFont(font)
        self.DetectOS.setInputMethodHints(Qt.InputMethodHint.ImhNone)
        self.DetectOS.setReadOnly(True)
        self.DetectOS.setOverwriteMode(False)
        self.DetectOS.setAcceptRichText(False)
        self.DetectOS.setObjectName("DetectOS")
        ...
        self.AuthorLabel.setGeometry(QRect(210, 185, 246, 66))
        self.AuthorLabel.setFont(font_author)
        self.AuthorLabel.setObjectName("AuthorLabel")
        self.ProjectLinkButton = QCommandLinkButton(self.AboutTab)
        self.ProjectLinkButton.setGeometry(QRect(150, 245, 300, 40))
        self.ProjectLinkButton.setObjectName("ProjectLinkButton")
        self.ProjectLinkButton.setChecked(False)
        self.ProjectLinkButton.setStyleSheet("QCommandLinkButton::!checked::!preseed"
                  "{"
    ...
    def start_scan(self):
        ...
        if self.IpInput.text() != "":
            ...
            self.scan.start()
            #self.detect_os()
            #self.scan.signal_detect_os.connect(self.update_detect_os)
            #self.DetectOS.setText(os)
            #print("Buraya Girdi")
    ...
    def detect_os(self):
        ...
        if resp:
            if IP in resp:
                ...
                self.DetectOS.setText(f'TTL = {ttl} --> {os} detected')
                return os

    def update_detect_os(self,os):
        self.DetectOS.setText(os)
    ...
    def retranslateUi(self, dialog):
        ...
        dialog.setWindowTitle(_translate("dialog", "Port Scanner"))
        ...
        self.DetectOS.setPlaceholderText(_translate("dialog", "OS Detection"))
        ...
        self.AuthorLabel.setText(_translate("dialog", "By Aybars Erenkul"))
        self.ProjectLinkButton.setText(_translate("dialog", "https://github.com/Aybars-Erenkul"))
